...
class ActionSettings(BaseModel):
    ...
    manualfocusdrive: Optional[
        Literal["Near 1", "Near 2", "Near 3", "None", "Far 1", "Far 2", "Far 3"]
    ] = None
...
class Settings(BaseModel):
    ...
    autopoweroff: Optional[
        Literal["15", "30", "60", "180", "300", "600", "1800", "0", "4294967295"]
    ] = None
...
class CaptureSettings(BaseModel):
    ...
    meteringmode: Optional[
        Literal["Spot", "Evaluative", "Partial", "Center-weighted average"]
    ] = None
    ...
    alomode: Optional[
        Literal["Standard (disabled in manual exposure)", "x1", "x2", "x3"]
    ] = None
